"""Shared text/data cleaning for recipe CSV ingestion."""
...
def clean_recipes_dataframe(df: pd.DataFrame) -> pd.DataFrame:
    """Drop invalid rows and assign stable recipe ids."""
